...
function testAjaxSession() {
    $.ajax({
        method: "GET",
        url: "../../phpscripts/test-session.php",
        dataType: "json",
        xhrFields: {
            withCredentials: true // ✅ Ensures session cookies are sent
        },
        success: function (response) {
            console.log("AJAX Session Test Response:", response);
            alert("AJAX Test: " + response.message + " (User ID: " + response.user_id + ")");
        },
        error: function (xhr, status, error) {
