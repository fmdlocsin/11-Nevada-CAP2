...
INSERT INTO `agreement_contract` (`ac_id`, `franchisee`, `classification`, `rights_granted`, `franchise_term`, `agreement_date`, `location`, `area_code`, `franchise_fee`, `ff_note`, `franchise_package`, `fp_note`, `bond`, `b_note`, `extra_note`, `notarization_fr`, `notarization_fr_rb`, `notarization_fe`, `notarization_fe_rb`, `notary_public_seal`, `status`, `datetime_added`) VALUES
(261467, 'auntie-anne', 'Inline Store ', 'non-exclusive,use-trademarks,sell-products', 'undefined', '2025-02-11', 'Greenbelt Mall', 1228, 700000, 'Covers rights to use branding, training, and marketing support.', 2000000, 'Includes equipment, initial supplies, and store construction.', '250000', 'Refundable upon franchise termination, subject to conditions.', 'Franchisees are required to undergo training and adhere to Auntie Annes global standards. Fees are subject to applicable taxes.', 'Auntie Annes Philippines', 'Josephine Gomez', 'Maria Cruz', 'Carlos Santos', 'notarySealAgreement-20241118175240.png', 'active', '2024-11-19'),
(293063, 'potato-corner', 'Stall', 'non-exclusive,use-trademarks,sell-products', 'undefined', '2024-11-30', 'Glorietta Mall', 1228,
 600000, 'Includes training, branding rights, and marketing support', 1500000, 'Covers equipment, initial inventory, and setup costs', '200000', 'Refundable upon franchise termination, subject to conditions', 'All fees are exclusive of applicable taxes. Additional costs may apply for site-specific requirements and upgrades.', 'Potato Corner', 'Kevin Tan', 'Maria Lopez', 'Ricardo Villanueva', 'notarySealAgreement-20241118180148.png', 'active', '2024-11-19'),
(799557, 'macao-imperial', 'Store', 'non-exclusive,use-trademarks,sell-products', 'undefined', '2024-11-17', 'Robinsons Galleria', 1100, 800000, 'Covered brand usage, training, and marketing support', 2500000, 'Included equipment, initial ingredients, and store construction', '300000', 'Refundable upon franchise termination, subject to conditions', 'This franchise term has expired. Renewal terms or further agreements must be negotiated with Macao Imperial Tea Philippines Inc.', 'Macao Imperial Tea', 'Jennifer Lopez', 'Anna Marie', 'Michael Cruz', 'notarySealAgreement-20241118175831.png', 'active', '2024-11-19'),
(808563, 'potato-corner', 'Kiosk', 'non-exclusive,use-trademarks,sell-products', 'undefined', '2025-02-09', 'SM Fairview, Quezon City', 1124, 600000, 'Covers training, branding rights, and marketing support', 1800000, 'Includes equipment, initial inventory, and store construction', '200000', 'Refundable upon franchise termination, provided conditions are met', 'All fees are exclusive of applicable taxes. Additional charges may apply for location-specific adjustments.', 'Potato Corner Philippines', 'Elena Cruz', 'Gabriel Reyes', 'Gabriel Reyes', 'notarySealAgreement-20241118183655.png', 'active', '2024-11-19'),
(946864, 'macao-imperial', 'Store', 'non-exclusive,use-trademarks,sell-products', 'undefined', '2024-12-17', 'Ayala Malls Manila Bay', 1701, 800000, 'Covers brand usage, training, and marketing support', 3000000, 'Includes equipment, initial ingredients, and store construction', '300000', 'Refundable upon franchise termination, subject to conditions', 'Franchise fees are exclusive of VAT. Additional charges may apply for renovations, location-specific needs, and compliance with Macao Imperial Tea design standards.', 'Macao Imperial Tea', 'Amanda Villanueva', 'Miguel Rosa', 'Luis Gonzales', 'notarySealAgreement-20241118175537.png', 'active', '2024-11-19'),
(953464, 'potato-corner', 'Kiosk', 'non-exclusive,use-trademarks,sell-products', 'undefined', '2025-11-19', 'SM Mall of Asia', 1300, 500000, 'Includes initial training, franchise setup support, and marketing materials.', 1200000, 'Covers equipment, initial supplies, and store construction.', '200000', 'Refundable upon franchise termination, subject to conditions.', 'All fees are subject to applicable taxes. Additional costs may apply for renovations or site-specific adjustments.', 'Potato Corner Philippines', 'Anna Santos', 'Juan Dela Cruz', 'Mark Reyes', 'notarySealAgreement-20241118175058.png', 'active', '2024-11-19');
